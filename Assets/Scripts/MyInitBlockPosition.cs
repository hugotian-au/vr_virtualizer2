...
{
    private Vector3 blockPosition1 = new Vector3(0.493f, 1.28f, -1.365f);
    private Quaternion blockRotatoin1 = Quaternion.Euler(-83.369f, 185.838f, -10.511f);

    private Vector3 blockPosition2 = new Vector3(0.879f, 1.18f, -1.365f);
    private Quaternion blockRotatoin2 = Quaternion.Euler(-90.00001f, 0f, -181.849f);

    private Vector3 blockPosition3 = new Vector3(1.172f, 1.163f, -1.342f);
    ...
    private Vector3 blockPosition5 = new Vector3(1.033f, 1.52f, -1.191f);
    private Quaternion blockRotatoin5 = Quaternion.Euler(0f, 0f, -93.97201f);

    private Vector3 blockPosition6 = new Vector3(1.171f, 1.516f, -1.221f);
    private Quaternion blockRotatoin6 = Quaternion.Euler(0f, 92.313f, 0f);

    private Vector3 blockPosition7 = new Vector3(0.539f, 0.844f, -1.183f);
